...
void DataSeed()
{
    ...
    strcpy(Students[0].Name,"Md Khorshed Alom");
    strcpy(Students[0].Phone,"01886007101");
    strcpy(Students[0].Email,"mkneel101@gmail.com");
    Students[0].NumberOfCourse=1;

    strcpy(Courses[0].StudentID,"231015001");
    strcpy(Courses[0].Code,"CSE-1");
    strcpy(Courses[0].Name,"Course - 1");

    //-- student 2
    strcpy(Students[1].ID,"S-2");
    strcpy(Students[1].Name,"MK Neel");
    strcpy(Students[1].Phone,"017********");
    strcpy(Students[1].Email,"test@gmail.com");
    Students[1].NumberOfCourse=2;

    strcpy(Courses[1].StudentID,"231015002");
    ...
    strcpy(Students[2].Phone,"016********");
    strcpy(Students[2].Email,"test@gmail.com");
